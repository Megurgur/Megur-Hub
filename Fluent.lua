...
local aa = {
    ...
    [11] = function()
        ...
        return function(m, n, o, p)
            ...
            function q.Hide(r, s)
                q.Frame.Visible = false
            end
            function q.Show(r, s)
                q.Frame.Visible = true
            end
    ...
    [27] = function()
        ...
        function c.New(d, e, f)
            ...
            function h.AddConfig(m, n)
                table.insert(h.ConfigTable, n)
                h.SetShowConfig(h.ShowConfig)
            end
            function h.OnChanged(m, n)
                h.Changed = n
                n(h.Value)
            ...
            function h.SetShowConfig(m, n)
                n = not not n
                h.ShowConfig = n
                if (n) then
                    for _, element in h.ConfigTable do
                        element:Show()
                    end
                elseif (not n) then
                    for _, element in h.ConfigTable do
            ...
            ah.AddSignal(i.Frame.MouseButton2Click, function()
                h:SetShowConfig(not h.ShowConfig)
            end)
            h:SetValue(h.Value)
            g.Options[e] = h
            return h
